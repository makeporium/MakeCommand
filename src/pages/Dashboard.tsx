  ...
  return (
    <div className="space-y-6 md:space-y-8">
      <div className="text-center md:text-left">
        <h1 className="text-2xl md:text-4xl font-bold text-white mb-2">Welcome to NEXUS</h1>
        <p className="text-gray-400 text-base md:text-lg">Your personal command center awaits</p>
      </div>
